...
--
-- Table structure for table `assoctradlang`
--

DROP TABLE IF EXISTS `assoctradlang`;
CREATE TABLE IF NOT EXISTS `assoctradlang` (
  `id_assoc` int(255) NOT NULL AUTO_INCREMENT,
  `id_langue` int(255) NOT NULL,
  `id_traduc` int(255) NOT NULL,
...
--
-- Dumping data for table `assoctradlang`
--
...
--
-- Table structure for table `assoctradtraduction`
--

DROP TABLE IF EXISTS `assoctradtraduction`;
CREATE TABLE IF NOT EXISTS `assoctradtraduction` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `idTrad` int(11) NOT NULL,
  `idTraduction` int(11) NOT NULL,
  `unseen` int(11) NOT NULL DEFAULT '1',
  `supp` int(255) NOT NULL DEFAULT '0',
  `reponse` varchar(255) DEFAULT NULL,
  `clientunseen` int(255) NOT NULL DEFAULT '0',
  `type` int(255) NOT NULL DEFAULT '0',
  `note` int(255) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=54 DEFAULT CHARSET=latin1;

--
-- Dumping data for table `assoctradtraduction`
--
...
--
-- Table structure for table `assoctradtype`
--

DROP TABLE IF EXISTS `assoctradtype`;
CREATE TABLE IF NOT EXISTS `assoctradtype` (
...
--
-- Dumping data for table `assoctradtype`
--
...
CREATE TABLE IF NOT EXISTS `client` (
  ...
  `wilaya` int(255) NOT NULL,
  `commune` int(255) NOT NULL,
...
INSERT INTO `communes` (`id`, `code_postal`, `nom`, `wilaya_id`) VALUES
(1, '01001', 'Adrar', 1),
(2, '01002', 'Tamest', 1),
(3, '01003', 'Charouine', 1),
(4, '01004', 'Reggane', 1),
...
--
-- Table structure for table `documentsoumis`
--

DROP TABLE IF EXISTS `documentsoumis`;
CREATE TABLE IF NOT EXISTS `documentsoumis` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nom` varchar(255) NOT NULL,
  `chemin` varchar(255) NOT NULL,
  `date` date DEFAULT NULL,
  `type` varchar(255) DEFAULT NULL,
  `devisVsTrad` int(11) DEFAULT NULL,
  `client` varchar(255) DEFAULT NULL,
  `traducteur` varchar(255) DEFAULT NULL,
  `idTraduction` int(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=73 DEFAULT CHARSET=latin1;

--
-- Dumping data for table `documentsoumis`
--
...
--
-- Table structure for table `fichiertraducteurs`
--

DROP TABLE IF EXISTS `fichiertraducteurs`;
CREATE TABLE IF NOT EXISTS `fichiertraducteurs` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nom` varchar(30) NOT NULL,
  `chemin` varchar(255) NOT NULL,
  `typeFich` int(11) NOT NULL,
  `idTrad` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fichiertraducteurs_ibfk_1` (`idTrad`)
...
CREATE TABLE IF NOT EXISTS `traducteur` (
  ...
  `prenom` varchar(255) NOT NULL,
  `id` int(255) NOT NULL AUTO_INCREMENT,
  `idWilaya` int(255) DEFAULT NULL,
  `idCommune` int(255) DEFAULT NULL,
  `adresse` varchar(255) NOT NULL,
  `email` varchar(255) NOT NULL,
  `mdp` varchar(255) NOT NULL,
  `tel` int(255) DEFAULT NULL,
  `fax` int(255) DEFAULT NULL,
  `asseremente` int(255) NOT NULL,
  `supprime` int(10) DEFAULT NULL,
  `bloque` int(11) DEFAULT NULL,
  `Note` varchar(55) DEFAULT NULL,
  `nbTraductions` int(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `traduction` (
  ...
  `typeTrad` int(11) NOT NULL,
  `langOrigin` int(11) NOT NULL,
  `langDest` int(11) NOT NULL,
  `asserm` int(11) NOT NULL,
  `devisVsTrad` int(11) NOT NULL,
  PRIMARY KEY (`id`)
...
--
-- Table structure for table `typetraduction`
--

DROP TABLE IF EXISTS `typetraduction`;
...
--
-- Dumping data for table `typetraduction`
--

INSERT INTO `typetraduction` (`id`, `nom`) VALUES
(1, 'General'),
(2, 'Scientifique'),
(3, 'Site');
...
--
-- Constraints for table `assoctradlang`
--
ALTER TABLE `assoctradlang`
  ADD CONSTRAINT `assoctradlang_ibfk_1` FOREIGN KEY (`id_traduc`) REFERENCES `traducteur` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `assoctradlang_ibfk_2` FOREIGN KEY (`id_langue`) REFERENCES `langue` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `assoctradtype`
--
ALTER TABLE `assoctradtype`
  ADD CONSTRAINT `assoctradtype_ibfk_1` FOREIGN KEY (`id_traduc`) REFERENCES `traducteur` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `assoctradtype_ibfk_2` FOREIGN KEY (`id_type`) REFERENCES `typetraduction` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
